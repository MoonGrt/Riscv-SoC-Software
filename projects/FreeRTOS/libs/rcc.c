...
void RCC_PLL2Cmd(FunctionalState NewState)
{
    ...
    *(volatile uint32_t *)CR_PLL2ON_BB = (uint32_t)NewState;
}
...
void RCC_PLL3Cmd(FunctionalState NewState)
{
    ...
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    *(volatile uint32_t *)CR_PLL3ON_BB = (uint32_t)NewState;
}
#endif /* STM32F10X_CL */
...
void RCC_ITConfig(uint8_t RCC_IT, FunctionalState NewState)
{
    ...
    if (NewState != DISABLE)
    {
        ...
        *(volatile uint8_t *)CIR_BYTE2_ADDRESS |= RCC_IT;
    }
    else
    {
        /* Perform Byte access to RCC_CIR bits to disable the selected interrupts */
        *(volatile uint8_t *)CIR_BYTE2_ADDRESS &= (uint8_t)~RCC_IT;
    }
}
...
void RCC_USBCLKConfig(uint32_t RCC_USBCLKSource)
{
    ...
    *(volatile uint32_t *)CFGR_USBPRE_BB = RCC_USBCLKSource;
}
#else
/**
...
void RCC_OTGFSCLKConfig(uint32_t RCC_OTGFSCLKSource)
{
    ...
    *(volatile uint32_t *)CFGR_OTGFSPRE_BB = RCC_OTGFSCLKSource;
}
#endif /* STM32F10X_CL */
...
void RCC_I2S2CLKConfig(uint32_t RCC_I2S2CLKSource)
{
    ...
    *(volatile uint32_t *)CFGR2_I2S2SRC_BB = RCC_I2S2CLKSource;
}
...
void RCC_I2S3CLKConfig(uint32_t RCC_I2S3CLKSource)
{
    ...
    *(volatile uint32_t *)CFGR2_I2S3SRC_BB = RCC_I2S3CLKSource;
}
#endif /* STM32F10X_CL */
...
void RCC_LSEConfig(uint8_t RCC_LSE)
{
    ...
    /* Reset LSEON bit */
    *(volatile uint8_t *)BDCR_ADDRESS = RCC_LSE_OFF;
    /* Reset LSEBYP bit */
    *(volatile uint8_t *)BDCR_ADDRESS = RCC_LSE_OFF;
    ...
    case RCC_LSE_ON:
        /* Set LSEON bit */
        *(volatile uint8_t *)BDCR_ADDRESS = RCC_LSE_ON;
        break;

    case RCC_LSE_Bypass:
        /* Set LSEBYP and LSEON bits */
        *(volatile uint8_t *)BDCR_ADDRESS = RCC_LSE_Bypass | RCC_LSE_ON;
        break;
...
void RCC_LSICmd(FunctionalState NewState)
{
    /* Check the parameters */
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    *(volatile uint32_t *)CSR_LSION_BB = (uint32_t)NewState;
}
...
void RCC_RTCCLKCmd(FunctionalState NewState)
{
    /* Check the parameters */
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    *(volatile uint32_t *)BDCR_RTCEN_BB = (uint32_t)NewState;
}
...
void RCC_BackupResetCmd(FunctionalState NewState)
{
    /* Check the parameters */
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    *(volatile uint32_t *)BDCR_BDRST_BB = (uint32_t)NewState;
}
...
void RCC_ClockSecuritySystemCmd(FunctionalState NewState)
{
    /* Check the parameters */
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    *(volatile uint32_t *)CR_CSSON_BB = (uint32_t)NewState;
}
...
void RCC_MCOConfig(uint8_t RCC_MCO)
{
    ...
    *(volatile uint8_t *)CFGR_BYTE4_ADDRESS = RCC_MCO;
}
...
void RCC_ClearITPendingBit(uint8_t RCC_IT)
{
    ...
    /* Perform Byte access to RCC_CIR[23:16] bits to clear the selected interrupt
       pending bits */
    *(volatile uint8_t *)CIR_BYTE3_ADDRESS = RCC_IT;
}
