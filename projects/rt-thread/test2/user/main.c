...
void DVP_init(void)
{
    ...
    DVP_InitStructure.VPMode.CutterMode = VP_Cutter | ENABLE;    // 启用 Cutter 模式
    ...
    DVP_InitStructure.VPMode.BinarizerMode = VP_Mirror | ENABLE; // 启用 Mirror 模式
    DVP_InitStructure.VPMode.FillMode = VP_White | ENABLE;       // 启用 白色填充模式
    // 配置 VO 模式
