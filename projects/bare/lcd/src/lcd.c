...
#define LCD_CLK_H() GPIO_SetBits(LCD_CLK_PORT, LCD_CLK_PIN)
#define LCD_CLK_L() GPIO_ResetBits(LCD_CLK_PORT, LCD_CLK_PIN)
#define LCD_MOSI_H() GPIO_SetBits(LCD_DATA_PORT, LCD_DATA_PIN)
#define LCD_MOSI_L() GPIO_ResetBits(LCD_DATA_PORT, LCD_DATA_PIN)
